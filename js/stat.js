...
// Функция поиска максимального элемента (вообще любого)
...
//возвращаем значение maxElement равное максимальному значению в массиве
  return maxElement;
};

// Функция вызова окна со статистикой при попадании
